	...
	$(function() {
		...
		$("#exerciseName").keyup(
				function() {
					...
					$.ajax({
						type : "get",
						url : "checkExerciseName.do?exerciseName="
								+ $.trim($("#exerciseName").val()),
						success : function(data) {
							if (data == "false") {
								$("#result").html(data).css("background",
										"pink");
								return false;
							} else {
								$("#result").html(data).css("background",
...
<div class="col-md-6">
	<form id="exerciseForm" method="post"
		...
		<div class="form-group">
			<label for="boardTitle" class="col-sm-2 control-label"> 제목 :
			</label>
			<div class="col-sm-10">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" id="exerciseName" name="exerciseName"
					...
					class="form-control"> <span id="result"></span>
			</div>
		</div>
		<div class="form-group">
