				...
				<tbody>
					<c:forEach items="${requestScope.cbList}" var="cbList">
						<tr>
							...
							<c:otherwise>
								<td><a href="my_getCommunityByNo.do?boardNo=${cbList.boardNo}">${cbList.boardTitle}</a></td>
							</c:otherwise>
							</c:choose>
					...
					<c:forEach items="${requestScope.cbList}" var="cbList">
						<tr>
							...
							<c:choose>
								...
								<c:otherwise>
									<td><a href="member_getCommunityByNo.do?boardNo=${cbList.boardNo}">${cbList.boardTitle}</a></td>
								</c:otherwise>
							</c:choose>
							<td>${cbList.momentorMemberVO.nickName}</td>
							<td>${cbList.boardWdate }</td>
