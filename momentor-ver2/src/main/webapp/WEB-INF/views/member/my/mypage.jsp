...
<p>
	<a class="btn btn-default" href="${initParam.root }my_getMyCommnunityBoardList.do?pageNo=1&memberId=${sessionScope.pnvo.momentorMemberVO.memberId}" role="button">
	 나의 게시글 보기  &raquo;</a>
	<a class="btn btn-default" href="${initParam.root }my_getMyReplyList.do?pageNo=1&memberId=${sessionScope.pnvo.momentorMemberVO.memberId}" role="button">나의 댓글 보기 &raquo;</a>
</p>